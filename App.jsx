            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {LIFE_STAGES.map(s => (
                <button key={s.id} onClick={() => setLifeStage(s.id)} style={{
                  textAlign: "left", padding: "10px 14px", borderRadius: 12, cursor: "pointer", fontFamily: "inherit",
                  background: lifeStage === s.id ? C.primaryLight : C.cardAlt,
              ...
              {NEWS_TOPICS.map(t => {
                ...
                return (
                  <button key={t.id} onClick={() => toggleTopic(t.id)} style={{
                    textAlign: "left", padding: "10px 14px", borderRadius: 12, cursor: "pointer", fontFamily: "inherit",
                    background: on ? "rgba(15,118,110,0.07)" : C.cardAlt,
              ...
              <div style={{ padding: "12px 10px", background: C.primaryLight, borderRadius: 12, marginBottom: 8 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div style={{ fontSize: 10, color: C.muted, fontWeight: 600 }}>👋 Hello,</div>
                    <div style={{ fontWeight: 800, fontSize: 14, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{user.name || "User"}</div>
                  </div>
                </div>
