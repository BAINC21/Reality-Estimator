  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      {activeTab === "overview" && (() => {
        ...
        const totalSavingsCommitted = totalMonthlySavings;
        const remaining = Math.max(0, totalIncome - totalBillsFixed - totalSavingsCommitted);
        const committedRatio = totalIncome > 0 ? Math.round(((totalBillsFixed + totalSavingsCommitted) / totalIncome) * 100) : 0;
        const savingsRatio = totalIncome > 0 ? Math.round((totalSavingsCommitted / totalIncome) * 100) : 0;
        ...
        const donutData = [
          ...
          { label: "Savings", value: totalSavingsCommitted, color: C.green },
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                  <div style={{ flexShrink: 0 }}>
                    <svg width="120" height="120" viewBox="0 0 120 120">
                      ...
                      <text x={cx} y={cy - 5} textAnchor="middle" fill={C.text} fontSize="13" fontWeight="700">{fmt(totalIncome)}</text>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              <Card style={{ textAlign: "center", padding: "14px 12px" }}>
                ...
                <div style={{ fontSize: 20, fontWeight: 700, color: C.green }}>{fmt(totalSavingsCommitted * 12)}</div>
                <div style={{ fontSize: 10, color: C.muted, marginTop: 2 }}>{fmt(totalSavingsCommitted)}/mo committed</div>
              </Card>
              <Card style={{ textAlign: "center", padding: "14px 12px" }}>
            ...
            {/* EMPTY STATE */}
            {totalIncome === 0 && totalBillsFixed === 0 && scenarios.length === 0 && (
