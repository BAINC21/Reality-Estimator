              ...
              <div style={{ padding: "12px 10px", background: C.primaryLight, borderRadius: 12, marginBottom: 8 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div style={{ fontSize: 12, color: C.muted, fontWeight: 600 }}>👋 Hello,</div>
                    <div style={{ fontWeight: 800, fontSize: 16, color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{user.name || "User"}</div>
                  </div>
                </div>
